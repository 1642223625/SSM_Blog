...
public class TestController {
	...
	public String content(HttpServletRequest request) {
		...
		return "test/content";// 该处只需要编写页面名称即可，框架会自动将其路径变为/WEB-INF/jsp/content.jsp
	}
	...
	public void download(String fileName, HttpServletRequest request, HttpServletResponse response) throws IOException {
		response.setHeader("Content-Disposition", "attachment;filename=diyName.jpg");
		OutputStream os = response.getOutputStream();// 获取和浏览器的通道
		String parent = request.getServletContext().getRealPath("files");// 获取"files"文件夹的绝对路径
